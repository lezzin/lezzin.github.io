...
export default [
    {
        ...
        description: [
            ...
            "Refatoração do microserviço de WhatsApp com NestJS, integrando a API da OMNE para extração de relatórios analíticos e agilidade na entrega de requisitos.",
